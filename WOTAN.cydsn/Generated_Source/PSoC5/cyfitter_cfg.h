...
extern void ChannelSel_Set(uint8 channel);
extern void ChannelSel_Unset(uint8 channel);
/* ChannelSel__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE ChannelSel__addrTable[5];
/* ChannelSel__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE ChannelSel__maskTable[5];
