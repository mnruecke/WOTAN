...
void  ShiftReg_1_WriteRegValue(uint8 shiftData) \
                                                                ;
uint8 ShiftReg_1_ReadRegValue(void) ;
uint8    ShiftReg_1_GetFIFOStatus(uint8 fifoId)           ;

#if(0u != ShiftReg_1_USE_INPUT_FIFO)
    cystatus ShiftReg_1_WriteData(uint8 shiftData) \
                                                                ;
#endif /* (0u != ShiftReg_1_USE_INPUT_FIFO) */

#if(0u != ShiftReg_1_USE_OUTPUT_FIFO)
    uint8 ShiftReg_1_ReadData(void) ;
...
#define ShiftReg_1_SR_MASK    (0xFu) /* Unsigned is added to parameter */
...
#define ShiftReg_1_SHIFT_REG_CAPTURE_PTR    ( (reg8 *) \
    ...
    #define ShiftReg_1_OUT_FIFO_VAL_LSB_PTR       ( (reg8 *) \
        ...
        #define ShiftReg_1_IN_FIFO_VAL_LSB_PTR        ( (reg16 *) \
                                  ShiftReg_1_bSR_sC8_BShiftRegDp_u0__16BIT_F0_REG )

        #define ShiftReg_1_SHIFT_REG_LSB_PTR          ( (reg16 *) \
                                  ShiftReg_1_bSR_sC8_BShiftRegDp_u0__16BIT_A0_REG )

        #define ShiftReg_1_SHIFT_REG_VALUE_LSB_PTR    ( (reg16 *) \
                                  ShiftReg_1_bSR_sC8_BShiftRegDp_u0__16BIT_A1_REG )

        #define ShiftReg_1_OUT_FIFO_VAL_LSB_PTR       ( (reg16 *) \
                                  ShiftReg_1_bSR_sC8_BShiftRegDp_u0__16BIT_F1_REG )
    ...
    #else /* 32bit - ShiftReg */
        #define ShiftReg_1_IN_FIFO_VAL_LSB_PTR        ( (reg32 *) \
                                  ShiftReg_1_bSR_sC8_BShiftRegDp_u0__32BIT_F0_REG )

        #define ShiftReg_1_SHIFT_REG_LSB_PTR          ( (reg32 *) \
                                  ShiftReg_1_bSR_sC8_BShiftRegDp_u0__32BIT_A0_REG )

        #define ShiftReg_1_SHIFT_REG_VALUE_LSB_PTR    ( (reg32 *) \
                                  ShiftReg_1_bSR_sC8_BShiftRegDp_u0__32BIT_A1_REG )

        #define ShiftReg_1_OUT_FIFO_VAL_LSB_PTR       ( (reg32 *) \
                                  ShiftReg_1_bSR_sC8_BShiftRegDp_u0__32BIT_F1_REG )
