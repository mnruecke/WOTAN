...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000734u)
...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000748u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000750u)

/* IOPINS0_2 Address: CYREG_PRT2_DR Size (bytes): 10 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000758u)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000764u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x4800076Cu)

/* PHUB_CFGMEM1 Address: CYREG_PHUB_CFGMEM1_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x48000770u)

/* PHUB_CFGMEM2 Address: CYREG_PHUB_CFGMEM2_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM2_VAL ((const uint8 CYFAR *)0x48000774u)

/* PHUB_CFGMEM3 Address: CYREG_PHUB_CFGMEM3_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM3_VAL ((const uint8 CYFAR *)0x48000778u)

/* PHUB_CFGMEM4 Address: CYREG_PHUB_CFGMEM4_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM4_VAL ((const uint8 CYFAR *)0x4800077Cu)

/* PHUB_CFGMEM5 Address: CYREG_PHUB_CFGMEM5_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM5_VAL ((const uint8 CYFAR *)0x48000780u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG0_CFG0), 0x004Du);
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_FASTCLK_PLL_P), 0x0118u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT2_AMUX, 0xA108u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DAC2_SW3, 0x10u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW4, 0x28u);
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP2_MX, 0x0104u);
...
uint8 CYXDATA * const CYCODE ChannelSel__addrTable[5] = {
	(uint8 CYXDATA *)CYREG_SC2_SW0, 
	(uint8 CYXDATA *)CYREG_DAC2_SW4, 
	(uint8 CYXDATA *)CYREG_SC2_SW0, 
	(uint8 CYXDATA *)CYREG_DSM0_SW6, 
	(uint8 CYXDATA *)CYREG_PRT0_AG, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ChannelSel__maskTable[5] = {
	0x01u, 
	0x10u, 
	0x02u, 
	0x08u, 
...
*
*******************************************************************************/
void ChannelSel_Set(uint8 channel)
{
	if (channel < 5)
	{
		*ChannelSel__addrTable[channel] |= ChannelSel__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: ChannelSel_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ChannelSel_Unset(uint8 channel)
{
	if (channel < 5)
	{
		*ChannelSel__addrTable[channel] &= (uint8)~ChannelSel__maskTable[channel];
	}
}
