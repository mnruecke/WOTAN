...
{
    CY_SET_REG8(ShiftReg_2_SHIFT_REG_LSB_PTR, shiftData);
}
    ...
    *******************************************************************************/
                                                                         ...
                                                                         
    {
        ...
        {
            CY_SET_REG8(ShiftReg_2_IN_FIFO_VAL_LSB_PTR, shiftData);
    ...
    *******************************************************************************/
    ...
    {
        return(CY_GET_REG8(ShiftReg_2_OUT_FIFO_VAL_LSB_PTR));
    }
...
uint8 ShiftReg_2_ReadRegValue(void) 
{
    ...
    {
        (void) CY_GET_REG8(ShiftReg_2_OUT_FIFO_VAL_LSB_PTR);
    }
    ...
    /* Read output FIFO */
    result  = CY_GET_REG8(ShiftReg_2_OUT_FIFO_VAL_LSB_PTR);
    
    #if(0u != (ShiftReg_2_SR_SIZE % 8u))
        result &= ((uint8) ShiftReg_2_SR_MASK);
