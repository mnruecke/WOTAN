...
static ShiftReg_3_BACKUP_STRUCT ShiftReg_3_backup =
{
    ...
    ((uint8) ShiftReg_3_DEFAULT_A0),
    ((uint8) ShiftReg_3_DEFAULT_A1),

    #if(CY_UDB_V0)
        ((uint8) ShiftReg_3_INT_SRC),
    #endif /* (CY_UDB_V0) */
};
...
void ShiftReg_3_SaveConfig(void) 
{
    ...
    ShiftReg_3_backup.saveSrA0Reg   = CY_GET_REG8(ShiftReg_3_SHIFT_REG_LSB_PTR);
    ShiftReg_3_backup.saveSrA1Reg   = CY_GET_REG8(ShiftReg_3_SHIFT_REG_VALUE_LSB_PTR);
...
void ShiftReg_3_RestoreConfig(void) 
{
    ...
    CY_SET_REG8(ShiftReg_3_SHIFT_REG_LSB_PTR, ShiftReg_3_backup.saveSrA0Reg);
    CY_SET_REG8(ShiftReg_3_SHIFT_REG_VALUE_LSB_PTR, ShiftReg_3_backup.saveSrA1Reg);
