...
static ShiftReg_4_BACKUP_STRUCT ShiftReg_4_backup =
{
    ...
    ((uint8) ShiftReg_4_DEFAULT_A0),
    ((uint8) ShiftReg_4_DEFAULT_A1),

    #if(CY_UDB_V0)
        ((uint8) ShiftReg_4_INT_SRC),
    #endif /* (CY_UDB_V0) */
};
...
void ShiftReg_4_SaveConfig(void) 
{
    ...
    ShiftReg_4_backup.saveSrA0Reg   = CY_GET_REG8(ShiftReg_4_SHIFT_REG_LSB_PTR);
    ShiftReg_4_backup.saveSrA1Reg   = CY_GET_REG8(ShiftReg_4_SHIFT_REG_VALUE_LSB_PTR);
...
void ShiftReg_4_RestoreConfig(void) 
{
    ...
    CY_SET_REG8(ShiftReg_4_SHIFT_REG_LSB_PTR, ShiftReg_4_backup.saveSrA0Reg);
    CY_SET_REG8(ShiftReg_4_SHIFT_REG_VALUE_LSB_PTR, ShiftReg_4_backup.saveSrA1Reg);
