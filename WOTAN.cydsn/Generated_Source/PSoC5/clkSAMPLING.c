...
/*******************************************************************************
* Function Name: clkSAMPLING_Start
********************************************************************************
*
* Summary:
...
void clkSAMPLING_Start(void) 
{
    ...
    clkSAMPLING_CLKEN |= clkSAMPLING_CLKEN_MASK;
	clkSAMPLING_CLKSTBY |= clkSAMPLING_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: clkSAMPLING_Stop
********************************************************************************
*
* Summary:
...
void clkSAMPLING_Stop(void) 
{
    ...
    clkSAMPLING_CLKEN &= (uint8)(~clkSAMPLING_CLKEN_MASK);
	clkSAMPLING_CLKSTBY &= (uint8)(~clkSAMPLING_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: clkSAMPLING_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((clkSAMPLING_CLKEN & clkSAMPLING_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = clkSAMPLING_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = clkSAMPLING_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* clkSAMPLING__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(clkSAMPLING_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(clkSAMPLING_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: clkSAMPLING_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: clkSAMPLING_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = clkSAMPLING_GetSourceRegister();
    uint16 oldDivider = clkSAMPLING_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = clkSAMPLING_CLKEN & clkSAMPLING_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((clkSAMPLING_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: clkSAMPLING_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(clkSAMPLING_DIV_PTR);
}


/*******************************************************************************
* Function Name: clkSAMPLING_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    clkSAMPLING_MOD_SRC |= modeBitMask & (uint8)clkSAMPLING_MODE_MASK;
}


/*******************************************************************************
* Function Name: clkSAMPLING_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    clkSAMPLING_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(clkSAMPLING_MODE_MASK));
}


/*******************************************************************************
* Function Name: clkSAMPLING_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return clkSAMPLING_MOD_SRC & (uint8)(clkSAMPLING_MODE_MASK);
}


/*******************************************************************************
* Function Name: clkSAMPLING_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = clkSAMPLING_GetDividerRegister();
    uint8 oldSrc = clkSAMPLING_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        clkSAMPLING_MOD_SRC |= CYCLK_SSS;
        clkSAMPLING_MOD_SRC =
            (clkSAMPLING_MOD_SRC & (uint8)(~clkSAMPLING_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: clkSAMPLING_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return clkSAMPLING_MOD_SRC & clkSAMPLING_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: clkSAMPLING_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    clkSAMPLING_PHASE = clkPhase & clkSAMPLING_PHASE_MASK;
}


/*******************************************************************************
* Function Name: clkSAMPLING_GetPhase
********************************************************************************
*
* Summary:
...
{
    return clkSAMPLING_PHASE & clkSAMPLING_PHASE_MASK;
}
