...
{
    CY_SET_REG8(ShiftReg_4_SHIFT_REG_LSB_PTR, shiftData);
}
    ...
    *******************************************************************************/
                                                                         ...
                                                                         
    {
        ...
        {
            CY_SET_REG8(ShiftReg_4_IN_FIFO_VAL_LSB_PTR, shiftData);
    ...
    *******************************************************************************/
    ...
    {
        return(CY_GET_REG8(ShiftReg_4_OUT_FIFO_VAL_LSB_PTR));
    }
...
uint8 ShiftReg_4_ReadRegValue(void) 
{
    ...
    {
        (void) CY_GET_REG8(ShiftReg_4_OUT_FIFO_VAL_LSB_PTR);
    }
    ...
    /* Read output FIFO */
    result  = CY_GET_REG8(ShiftReg_4_OUT_FIFO_VAL_LSB_PTR);
    
    #if(0u != (ShiftReg_4_SR_SIZE % 8u))
        result &= ((uint8) ShiftReg_4_SR_MASK);
