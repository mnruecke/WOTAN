...
#channel = b'1'  # show output of DAC 1a -> CH1
#channel = b'2'  # show output of DAC 1b -> CH2
#channel = b'3'  # show output of DAC 2  -> CH3
#channel = b'4'  # show output of DAC 4  -> CH5 (CH4 not accessible internally)

#channel = b'6'  # show signal voltage between GPIO P0.6 (-) and GPIO P0.7 (+)
""" ----------------------------- """
