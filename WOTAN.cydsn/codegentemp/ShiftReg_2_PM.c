...
static ShiftReg_2_BACKUP_STRUCT ShiftReg_2_backup =
{
    ...
    ((uint8) ShiftReg_2_DEFAULT_A0),
    ((uint8) ShiftReg_2_DEFAULT_A1),

    #if(CY_UDB_V0)
        ((uint8) ShiftReg_2_INT_SRC),
    #endif /* (CY_UDB_V0) */
};
...
void ShiftReg_2_SaveConfig(void) 
{
    ...
    ShiftReg_2_backup.saveSrA0Reg   = CY_GET_REG8(ShiftReg_2_SHIFT_REG_LSB_PTR);
    ShiftReg_2_backup.saveSrA1Reg   = CY_GET_REG8(ShiftReg_2_SHIFT_REG_VALUE_LSB_PTR);
...
void ShiftReg_2_RestoreConfig(void) 
{
    ...
    CY_SET_REG8(ShiftReg_2_SHIFT_REG_LSB_PTR, ShiftReg_2_backup.saveSrA0Reg);
    CY_SET_REG8(ShiftReg_2_SHIFT_REG_VALUE_LSB_PTR, ShiftReg_2_backup.saveSrA1Reg);
